...
import { customerPageActions, CustomerState, DataAccessModule } from "@venusta/portal/customer/data-access";
import { Customer } from "@venusta/portal/customer/models";

@Component({
  selector: 'venusta-create-customer',
  standalone: true,
  imports: [CommonModule, CustomerFormComponent, MatCardModule, DataAccessModule],
